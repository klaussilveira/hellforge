...
void WindowPosition::saveToPath(const std::string& path)
{
    ...
    registry::setValue(path + "/xPosition", _position.at(0));
    registry::setValue(path + "/yPosition", _position.at(1));
    registry::setValue(path + "/width", _size.at(0));
    registry::setValue(path + "/height", _size.at(1));
}
...
void WindowPosition::loadFromPath(const std::string& path)
{
    ...
    _position.at(0) = registry::getValue<int>(path + "/xPosition");
    _position.at(1) = registry::getValue<int>(path + "/yPosition");
