...
#define HellForgeVersion "3.1.0"
#define VCRedistDir "C:\Program Files\Microsoft Visual Studio\2022\Community\VC\Redist\MSVC\14.32.31326\"

[Setup]
AppName=HellForge
AppVerName=HellForge {#HellForgeVersion} x64
AppPublisher=HellForge
AppPublisherURL=https://github.com/klaussilveira/hellforge
AppSupportURL=https://github.com/klaussilveira/hellforge
AppUpdatesURL=https://github.com/klaussilveira/hellforge
DefaultDirName={pf}\HellForge
DefaultGroupName=HellForge {#HellForgeVersion} x64
OutputDir=.
OutputBaseFilename=hellforge-{#HellForgeVersion}-x64
Compression=lzma
...
[Files]
Source: "..\..\install\hellforge.exe"; DestDir: "{app}"; Flags: ignoreversion
...
[Icons]
Name: "{group}\HellForge"; Filename: "{app}\hellforge.exe";
Name: "{group}\{cm:UninstallProgram,HellForge}"; Filename: "{uninstallexe}"
Name: "{userdesktop}\HellForge"; Filename: "{app}\hellforge.exe"; Tasks: desktopicon

[InstallDelete]
; Remove all modules that are now integrated in the main executable
